...
**Versión de esta entrega:** 2026.09.25-phase10.2 — se comprueba en Ajustes, al final de todo.
...
- Antes de actualizar: confirma «Al día» y conserva una copia reciente. Después: verifica en Ajustes
  `2026.09.25-phase10.2`. La caché de esta versión es `discoteca-v57`; nunca incluye JSON de colección.
