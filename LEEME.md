...
**Versión de esta entrega:** 2026.09.25-phase10.3 — se comprueba en Ajustes, al final de todo.
...
- Antes de actualizar: confirma «Al día» y conserva una copia reciente. Después: verifica en Ajustes
  `2026.09.25-phase10.3`. La caché de esta versión es `discoteca-v58`; nunca incluye JSON de colección.
