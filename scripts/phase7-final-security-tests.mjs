...
must(/function fusionarCopiaRecuperacion\([^)]*restaurarBorrados/,'decisión explícita de restaurar tombstones');
...
console.log('✓ fase 7 final: restauración reversible y tombstones probados en ambos caminos');
